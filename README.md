...
The corpus currently contains 209 ingested scans drawn from 57 verified sources, totalling ~292.25 MiB on disk. The source-level index also tracks 15 candidate leads still being researched and 37 source records kept for provenance after being rejected as out of scope.

License breakdown across the 209 entries:

- 145 `LicenseRef-Public-Domain-Israel` (Public Domain (Israel; life + 70))
